'''
This code enables you to train a Convolutional Neural Network (CNN) from scratch
Abder-Rahman Ali
abder@cs.stir.ac.uk
'''
...
validation_directory = '/path_to_validation_directory'
test_directory = '/path_to_testing_directory'
...
print 'Those are the classes we are trying to classify:'
